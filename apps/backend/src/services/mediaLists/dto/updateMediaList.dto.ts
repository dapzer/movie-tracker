...
const updateMediaListSchema = z.object({
  ...
  description: z.string().min(0).max(MEDIA_LIST_DESCRIPTION_MAX_LENGTH_LIMIT).optional().meta({ maxLength: MEDIA_LIST_DESCRIPTION_MAX_LENGTH_LIMIT, example: "List of shows I plan to watch" }),
})
