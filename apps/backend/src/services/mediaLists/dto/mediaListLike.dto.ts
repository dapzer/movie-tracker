...
const mediaListLikeSchema = z.object({
  id: z.uuid().meta({ example: "056e7fa3-af3e-44b0-ae74-4f05f92e38d5" }),
  mediaListId: z.uuid().meta({ example: "056e7fa3-af3e-44b0-ae74-4f05f92e38d5" }),
  userId: z.uuid().meta({ example: "056e7fa3-af3e-44b0-ae74-4f05f92e38d5" }),
