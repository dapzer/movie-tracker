...
const userBanSchema = z.object({
  ...
  issuedBy: z.uuid().nullable().optional().meta({ format: "uuid", nullable: true, example: "e9a2f5b7-c6d3-4c0a-a35f-84c7f902ad59" }),
  ...
  issuerUserProfile: UserPublicDto.schema.nullable().optional(),
