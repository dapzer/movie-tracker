...
const userFollowSchema = z.object({
  ...
  followerId: z.uuid().meta({ format: "uuid", example: "b10c5d0d-4ce2-4e31-8d1a-7d1a0b944b3a" }),
  followingId: z.uuid().meta({ format: "uuid", example: "c0a5db1e-7a67-4b60-8b1f-53f3a7c3d7b1" }),
